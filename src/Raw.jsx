...
<div className="card mb-3" style="max-width: 540px;">
  <div className="row g-0">
    <div className="col-md-4">
      <img src={data.data.urlToImage ? data.data.urlToImage : "not found"} className="img-fluid rounded-start" alt="..."/>
    </div>
    <div className="col-md-8">
      <div className="card-body">
        <h5 className="card-title">{data.data.title}</h5>
        <p className="card-text">{data.data.description}</p>
        <p className="card-text"><small className="text-muted">{data.data.author ? data.data.author : "unknown author" }</small></p>
      </div>
    </div>
  </div>
</div>
